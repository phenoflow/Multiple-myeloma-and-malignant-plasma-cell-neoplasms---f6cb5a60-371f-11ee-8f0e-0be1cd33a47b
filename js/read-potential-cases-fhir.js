...
(async () => {
  ...
  await fs.writeFile("multiple-myeloma-and-malignant-plasma-cell-neoplasms-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("multiple-myeloma-and-malignant-plasma-cell-neoplasms-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
